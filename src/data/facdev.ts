...
export const FD_COLORS = {
  ink: 'var(--fd-ink)',
  clay: 'var(--c-faculty-dev)',
  claySoft: 'var(--fd-soft)',
  sage: 'var(--c-med-edu-research)',
  blue: 'var(--tone-slate)',
  ochre: 'var(--tone-gold)',
};
...
export function buildFacdev(lang: Lang) {
  ...
  const groups: FdGroup[] = [
    ...
    { zh: '實證醫學組', en: 'Evidence-Based Medicine', tone: 'var(--tone-plum)', lead: person('林秀真', 'Hsiu-Chen Lin', 'lead', '西醫 · 副教授', 'Physician · Assoc. Prof.', 'hsiu-chen-lin', 'hsiu-chen-lin'), descZh: '將實證醫學精神融入教學，培養師生實證查證與應用能力。', descEn: 'Embedding evidence-based medicine into teaching practice.' },
    { zh: '全人照護組', en: 'Holistic Care', tone: 'var(--c-med-edu-research)', lead: person('廖若帆', 'Faith Ruofan Liao', 'lead', '護理 · 副教授', 'Nursing · Assoc. Prof.', 'faith-ruofan-liao', 'faith-ruofan-liao'), descZh: '發展全人照護教案與跨職類教學，落實以人為本的醫學教育。', descEn: 'Holistic-care teaching cases and cross-professional education.' },
