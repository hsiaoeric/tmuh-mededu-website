 ...
 */
const PREVIEWABLE_KINDS: ReadonlySet<CmsDocumentKind> = new Set(['news', 'activities', 'people', 'kpis', 'honors', 'centers', 'digital_materials', 'facdev', 'ebm', 'holistic', 'holistic_research']);
