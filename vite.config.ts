 ...
 * link like `/ebm` never reaches index.html and the SPA never boots. Pages does
 * serve `404.html` for any unmatched path, so shipping a copy of the app there
 * makes deep links work: the app loads, react-router reads `location.pathname`
